                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            <div class="bg-white py-6 px-4 space-y-6 sm:p-6 relative">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                    <label for="roles" class="block text-sm font-medium text-gray-700 w-full">
                                        Select Role
                                    </label>
                                    <div class="col-span-6 sm:col-span-4 inline-flex w-full">
                                        <select
                                            v-model="form.roles"
                                            id="roles"
                                            name="roles[]"
                                            :disabled="!roles.length"
                                            class="form-select mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                        >
                                            <option disabled value="">Select roles</option>
                                            <option v-if="!roles.length" disabled>No roles available</option>
