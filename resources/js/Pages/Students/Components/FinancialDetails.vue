...
<template>
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-6 sm:col-span-6 md:col-span-4">
            ...
            <select id="own_property" v-model="formStore.student.own_property"
        ...
        <div class="col-span-6 sm:col-span-6 md:col-span-4">
            ...
            <select id="bank_savings" v-model="formStore.student.bank_savings"
                class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
        ...
        <div class="col-span-6 sm:col-span-6 md:col-span-4">
            ...
            <input type="number" id="tuition_budget" v-model="formStore.student.tuition_budget"
                class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                placeholder="Enter amount in USD"
                :class="{ 'text-red-900 focus:ring-red-500 focus:border-red-500 border-red-300': formStore.student.errors.tuition_budget }" />
            <InputError :message="formStore.student.errors.tuition_budget" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-6 md:col-span-4">
            ...
            <input type="text" id="bank_funds" v-model="formStore.student.bank_funds"
                class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                placeholder="Enter bank funds details"
                :class="{ 'text-red-900 focus:ring-red-500 focus:border-red-500 border-red-300': formStore.student.errors.bank_funds }" />
            <InputError :message="formStore.student.errors.bank_funds" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-6 md:col-span-4">
            ...
            <select id="tuition_payer" v-model="formStore.student.tuition_payer"
                class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                :class="{ 'text-red-900 focus:ring-red-500 focus:border-red-500 border-red-300': formStore.student.errors.tuition_payer }">
                <option value="">Select an option</option>
            ...
            <InputError :message="formStore.student.errors.tuition_payer" class="mt-2" />
        </div>
