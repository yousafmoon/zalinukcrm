          ...
          <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
              <div class="flex justify-between sm:flex-auto">
                ...
                <div class="space-x-1">
                  <PrimaryButton @click="navigateToStudentsIndex"  class="middle none center mr-4 rounded-sm focus:bg-green-500 bg-green-500 hover:bg-green-600 py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-green-500/20 transition-all hover:shadow-green-500/40 disabled:pointer-events-none"
                  data-ripple-light="true">
                    Back to Students
                  </PrimaryButton>
                  <PrimaryButton @click="generatePDF"  class="middle none center rounded-sm bg-orange-500 focus:bg-orange-500 hover:bg-orange-600 py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-orange-500/20 transition-all hover:shadow-orange-500/40 disabled:pointer-events-none"
                  data-ripple-light="true">
                    Download PDF
                  </PrimaryButton>
                </div>
            ...
            <div id="student-details" v-if="student" class="my-5 bg-white overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <div class="p-5 grid grid-cols-2 gap-4 w-screen">
                ...
                <p class="font-semibold text-gray-700">Do you or have you ever held any other nationalities? If YES, please specify</p>
                ...
                <p class="font-semibold text-gray-700">If you lost/stolen your passport (please upload police complaint report/FIR)?</p>
                <p>{{ student.fircopy }}</p>

                <p class="font-semibold text-gray-700">Give more details about your living situation, such as who you live with and who owns the property</p>
               ...
               <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">MAIN APPLICANT’S PASSPORT INFORMATION</h2>
                ...
                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">MAIN APPLICANT’S CONTACT DETAILS IN COUNTRY OF APPLICATION:</h2>
                ...
                <p class="font-semibold text-gray-700">Will this be your contact details during the application process?</p>
                <p>{{ student.contact_during_application }}</p>

                <p class="font-semibold text-gray-700">Main address and contact details of where you will be staying whilst in the UK</p>
                ...
                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">MAIN APPLICANT’S PARENT’S DETAILS (Father)</h2>
                ...
                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">MAIN APPLICANT’S PARENT’S DETAILS (Mother)</h2>
                ...
                <p class="font-semibold text-gray-700">Will you be travelling to the UK with someone who is NOT your partner, spouse, or dependent?</p>
                <p>{{ student.travelling_with_others }}</p>

                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">QUALIFICATIONS</h2>
                <p class="col-span-2 font-semibold text-gray-700">Please tell us about any Qualifications you hold at Degree level or higher:</p>
                ...
                <p class="font-semibold text-gray-700">Have you travelled OUTSIDE your country of residence in the last 10 years?</p>
                ...
                <p class="font-semibold text-gray-700">Have you been refused entry on arrival to the UK in the last 10 years?</p>
                <p>{{ student.refused_entry_uk }}</p>

                <p class="font-semibold text-gray-700">Have you ever been deported, removed or otherwise required to leave the UK?</p>
                <p>{{ student.deported_uk }}</p>

                <p class="font-semibold text-gray-700">Have you ever been deported, removed or otherwise required to leave any other country?</p>
                <p>{{ student.deported_other_country }}</p>

                <p class="font-semibold text-gray-700">Have you made an application to the UK Home Office to remain in the UK in the last 10 years?</p>
                <p>{{ student.applied_home_office }}</p>

                <p class="font-semibold text-gray-700">Have you ever been in breach of your Immigration conditions for the UK?</p>
                <p>{{ student.breach_immigration_conditions }}</p>

                <p class="font-semibold text-gray-700">Do you have any criminal convictions in any country (including traffic offences)?</p>
                <p>{{ student.criminal_convictions }}</p>
                
                <p class="font-semibold text-gray-700">Have you ever been charged in any country with a criminal offence for which you have not yet been tried in a court (including traffic offences)?</p>
                <p>{{ student.charged_criminal_offence }}</p>

                <p class="font-semibold text-gray-700">In times of either peace or war, have you ever been involved in or suspected of involvement in war crimes, crimes against humanity or genocide?</p>
                <p>{{ student.involved_in_war_crimes }}</p>

                <p class="font-semibold text-gray-700">Have you ever been involved in, supported or encouraged terrorist activity in any country?</p>
                <p>{{ student.involved_in_terrorism }}</p>

                
                <p class="font-semibold text-gray-700">Have you engaged in any other activities that might include any which may mean you may not be considered a person of good character?</p>
                <p>{{ student.activities_bad_character }}</p>

                <p class="font-semibold text-gray-700">Have you at any point in the past had treatment via the UK National Health Service to the value in excess of £1000 which may remain unpaid?</p>
                ...
                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">  PLEASE PROVIDE THE FOLLOWING INFORMATION – IF APPLICABLE – EVEN IF YOUR FAMILY ARE NOT ACCOMPANYING YOU TO THE UK.
                </h2>
                ...
                <p class="font-semibold text-gray-700">Will your spouse / partner be accompanying you to the United Kingdom?</p>
                ...
                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4"> THIS PAGE SHOULD ONLY BE COMPLETED IF YOUR SPOUSE / PARTNER WILL ACCOMPANY YOU TO THE UK.</h2>
                ...
                <h2 class="col-span-2 text-lg font-semibold text-gray-800 mt-4">Please forward this completed questionnaire and the following copy documents to your admission officer at ZALINUK CONSULTANTS</h2>
                  
                <p class="font-semibold text-gray-700">Copy of current passports for all applicants confirming personal details</p>
