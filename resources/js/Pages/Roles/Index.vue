...
let roleIdToDelete = ref(null);

function handleDelete() {
    showModal.value = false; 
    try {
        router.delete(route('roles.destroy', roleIdToDelete.value), {
            onSuccess: () => {
                    ...
                    <div class="mt-8 flex flex-col">
                        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            ...
                            >
                                        ...
                                        >
                                            <tr v-for="role in roles.data" :key="role.id">
                                                ...
                                                <ul class="flex-inline flex-row flex flex-wrap w-9/12">
                                                    <li v-for="(permission, index) in role.permissions" :key="permission.id">
                                                        {{ permission.name }}<span v-if="index < role.permissions.length - 1">, </span>
                                                        </li>
                                ...
                                <div><Pagination  :data="roles" baseRoute="/roles"
